...
<!--
[대사 — 12초]
안녕하세요. AI 기반 미루기 분석 앱 Delay Detective를 개발한 신혜지입니다.
-->
...
<!--
[대사 — 15초]
미루는 건 의지력 문제가 아니라 태스크가 막막해서입니다.
기존 앱은 왜 미루는지 묻지 않습니다. Delay Detective는 AI가 직접 물어보고 소태스크로 잘라줍니다.
-->
...
<!--
[대사 — 10초]
서버 없이 오프라인도 동작하도록 Hive와 Firestore를 조합했고, 5개 AI 에이전트 팀으로 개발했습니다.
-->
...
<!--
[대사 — 10초]
각 주차마다 전담 AI 에이전트를 투입해 마일스톤 4개를 모두 달성했습니다.
-->
...
<!--
[대사 — 12초]
오프라인 변경은 sync_queue에 쌓고, 복구 시 updatedAt 비교로 최신 데이터를 선택합니다.
-->
...
<!--
[대사 — 10초]
지금 바로 웹과 Android에서 사용 가능하며, AI 에이전트 템플릿은 다음 프로젝트에도 재사용합니다.
-->
...
<!--
[대사 — 8초]
모든 기술 결정은 ADR로 문서화해 Q&A에 바로 답변 가능합니다.
-->
...
<!--
[대사 — 10초]
클린 아키텍처 4-레이어로 구성했고, Domain은 외부 의존 없이 독립 테스트가 가능합니다.
-->
...
<!--
[대사 — 7초]
Flutter 3.x, VS Code, Firebase CLI 기반입니다.
-->
...
<!--
[대사 — 8초]
APK, AAB, 웹 빌드 모두 완료하고 Firebase Hosting 배포까지 마쳤습니다.
-->
...
<!--
[대사 — 8초]
단방향 의존성, 오프라인 우선 Hive 저장 후 Firestore 동기화 구조입니다.
-->
...
<!--
[대사 — 12초]
5가지 버그 중 가장 어려웠던 건 웹과 Android Google 로그인 방식의 차이였습니다.
-->
...
<!--
[대사 — 10초]
캘린더는 LayoutBuilder로 최적화하고, AI 응답은 스트림으로 실시간 타이핑 구현했습니다.
-->
...
<!--
[대사 — 8초]
보안 파일은 모두 .gitignore 처리하고 레이어별 독립 테스트가 가능합니다.
-->
...
<!--
[대사 — 10초]
단위 테스트 11개 전체 통과, Playwright MCP로 E2E 3개 시나리오 자동화했습니다.
-->
...
<!--
[대사 — 6초]
3단계로 설치 가능하며 setup.md에 상세 안내가 있습니다.
-->
...
<!--
[대사 — 10초]
홈 캘린더, 할일 목록, AI 분석, 통계 4탭으로 구성되며 오프라인에서도 동작합니다.
-->
...
<!--
[대사 — 18초]
로그인 → 마감 초과 태스크 확인 → AI 인터뷰 2~3턴 → 소태스크 3개 자동 생성 → 통계로 확인합니다.
-->
...
<!--
[대사 — 12초]
3일째 미루던 태스크가 인터뷰 2턴 만에 15분 소태스크 3개로 쪼개집니다.
-->
...
<!--
[대사 — 10초]
Must 100%, 웹·Android 동시 배포 완료. 향후 FCM과 iOS 배포를 추진합니다.
-->
